...
GO
/*
The column [dbo].[Products].[Inventory] is being dropped, data loss could occur.
*/
...
GO
ALTER TABLE [dbo].[Products] DROP CONSTRAINT [DF__tmp_ms_xx__Inven__1CF15040];
...
GO
ALTER TABLE [dbo].[Products] DROP COLUMN [Inventory];
