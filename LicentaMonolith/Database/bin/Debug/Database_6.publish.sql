...
GO
PRINT N'Creating [dbo].[FK_Inventory_Product]...';


GO
ALTER TABLE [dbo].[Inventory] WITH NOCHECK
    ADD CONSTRAINT [FK_Inventory_Product] FOREIGN KEY ([ProductId]) REFERENCES [dbo].[Product] ([Id]);
...
GO
ALTER TABLE [dbo].[Inventory] WITH CHECK CHECK CONSTRAINT [FK_Inventory_Product];
